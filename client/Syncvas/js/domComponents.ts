...
function TextTool(selectTool: (toolName: string) => void): HTMLButtonElement {
    return create("button", {
        id: "text",
...
function ArrowTool(selectTool: (toolName: string) => void): HTMLButtonElement {
    return create("button", {
        id: "arrow",
...
function CircleTool(selectTool: (toolName: string) => void): HTMLButtonElement {
    return create("button", {
        id: "circle",
...
function LineTool(selectTool: (toolName: string) => void): HTMLButtonElement {
    return create("button", {
        id: "line",
